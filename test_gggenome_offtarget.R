...
# sequences <- c("GCTTTTTGCCATCCTGGGCG", "TTTTTGCCATCCTGGGCGCT", "TTTTGCCATCCTGGG", 
#                "TTTGCCATCCTGGGC", "TTGCCATCCTGGGCG", "TGCCATCCTGGGCGC", "GCCATCCTGGGCGCT", 
#                "ATCCTGGGCGCTAGA", "TCCTGGGCGCTAGAG", "TGGGCGCTAGAGGGA")
# 
...
summary_server <- target_annotation %>%
  mutate(results = map2(name, length, ~ {
    res <- run_all(.x)          # voer de functie uit
